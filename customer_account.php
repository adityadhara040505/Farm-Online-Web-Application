...
// Retrieve the Farm ID from the query parameters if available
   ...
   <div class="header_section">
      ...
      <div class="container-fluid">
         <div class="layout_border" style="padding: 3%;">
            <h1 align="center" style="font-size: xx-large; font-weight: bold;">Hello <?php echo $_SESSION["customerName"]."<br>"; ?>Welcome to your Profile</h1>
            <div style="display: flex; justify-content: center;">
                <table class="table table-active table-light" style="margin-top: 8%; width: 50%;">
                    <tr>
                        <th><h1>Your Name: </h1></th>
                        <td><h1 style="font-weight: bold;"><?php echo $_SESSION["customerName"] ?></h1></td>
                    </tr>
                    <tr>
                        <th><h1>Your Mobile Number: </h1></th>
                        <td><h1 style="font-weight: bold;"><?php echo $_SESSION["customerMbNumber"] ?></h1></td>
                    </tr>
                </table>
            </div>
         </div>
         ...
         <div class="container">
               ...
               <div class="row" style="padding-top: 1%; padding-bottom: 1%;">
                  <div class="col-sm-12">
                     <div style="font-size: xx-large; font-style: bold;">Hey <?php  echo $_SESSION["customerName"];?></div>
                     <div style="font-size: medium;">Would you like to do some shopping today?</div>
                  </div>
                  <div class="col-md-12 mt-4 mb-4">
                     <?php
                        // $sql = "SELECT * FROM online_crop_data";
                        $sql = "SELECT `crop_id`, `crop_name`, `crop_catagory`, `farm_id`, `crop_image`, `price`, `current_quantity` FROM `online_crop_data`;";
