...
if(isset($_POST["signupBtn"])){
    ...
    $mobileNo = $_POST["farmerMbNumber"];
    $pass = $_POST["farmerPass"];
    if($obj->add_farmer_reg($name, $mobileNo, $pass)){

        $_SESSION["farmerName"] = $name;
        $_SESSION["farmerMbNumber"] = $mobileNo;
        $_SESSION["farmerPass"] = $pass;
...
if(isset($_POST["loginBtn"])){
    ...
    if($obj->check_farmer_existance($mobileNo,$pass)){
        
        $_SESSION["farmerName"] = $obj->get_farmer_name($mobileNo);
        $_SESSION["farmerMbNumber"] = $mobileNo;
        $_SESSION["farmerPass"] = $pass;
            ...
            <div class="container" style="border-radius: 20px; margin-top: 70px;">
                ...
                <div class="box-1">
                    <div class="content-holder">
                        <h2>Hello Farmer, Welcome Please enter details</h2>
               ...
               <!--Create Container for Signup form-->
                ...
                <form action="#" method="post">
                    <h1>Sign Up Form</h1>
                    <input type="text" placeholder="Name" class="input-field" name="farmerName">
                    <br><br>
                    <input type="number" placeholder="Mobile Number" class="input-field" name="farmerMbNumber">
                    <br><br>
                    <input type="password" placeholder="Password" class="input-field" name="farmerPass" id="pass">
                    <br><br>
                    ...
                    <br>
                    <button class="signup-button" type="submit" name="signupBtn">Sign Up</button>
                    </form>
                </div>
